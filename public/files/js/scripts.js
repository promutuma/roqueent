!(function (NioApp, $) {
    ...
    NioApp.Custom.Stepper = function (elm, opt) {
        ...
        let nav_items = elm.querySelectorAll(`.${settings.selectors.nav} > *`),
            ...
            step_progress_count = elm.querySelector(`.${settings.selectors.progress}-count`),
            step_progress_bar = elm.querySelector(`.${settings.selectors.progress}-bar`),
            step_prev = elm.querySelector(`.${settings.selectors.prev}`),
            step_next = elm.querySelector(`.${settings.selectors.next}`),
            step_submit = elm.querySelector(`.${settings.selectors.submit}`),
            ...
            _step_nav = (elm.querySelectorAll(`.${settings.selectors.nav}`).length > 0) ? true : false,
            _step_progress = (elm.querySelectorAll(`.${settings.selectors.progress}`).length > 0) ? true : false;
        //Show step function
