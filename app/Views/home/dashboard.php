                        ...
                        <?php foreach ($sales as $row) : ?>
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-lg">
                                    <span class="tb-sub"><?php $date = date_create($row['sale_date'] . " " . $row['sale_time']);
                                                            echo date_format($date, "D, jS M Y H:i:s (e)") ?></span>
                                </div>
                                <div class="nk-tb-col">
                                    <span class="tb-sub tb-amount"><span>KSh </span><?php echo number_format($row['amount'], 2) ?></span>
                                </div>
                                <div class="nk-tb-col tb-col-sm">
                                    <span class="tb-sub <?php if ($row['sale_status'] == 'Complete') {
                                                            echo "text-success";
                    ...
                    <div class="nk-tb-list">
                        ...
                        <?php foreach ($expense as $row) : ?>
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-lg">
                                    <span class="tb-sub"><?php $date = date_create($row['date'] . " " . $row['time']);
                                                            echo date_format($date, "D, jS M Y H:i:s (e)") ?></span>
                                </div>
                                <div class="nk-tb-col">
                    ...
                    <ul class="nk-activity">
                        <?php foreach ($logs as $row) : ?>
                            <li class="nk-activity-item">
                                <div class="nk-activity-media user-avatar <?php if ($row['session_id'] % 4 == 0) {
                                                                                echo 'bg-azure';
                                                                            } elseif ($row['session_id'] % 3 == 0) {
                                                                                echo 'bg-warning';
                                                                            } elseif ($row['session_id'] % 2 == 0) {
                                                                                echo 'bg-purple';
                                                                            } else {
                                                                                echo 'bg-pink';
                                ...
                                <div class="nk-activity-data">
                                    ...
                                    <span class="time"><?php $minutes = ($currentTime - $row['log_id']) / 60;
                                                        if ($minutes < 120) {
                                                            ...
                                                            echo number_format($minutes / 60) . " Hours ago";
                                                        } else {
                                                            echo number_format($minutes / 1440) . " Days ago";
                                                        } ?></span>
                                </div>
                            </li>
                        <?php endforeach; ?>
